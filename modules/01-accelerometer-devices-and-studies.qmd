...
Site is rendered at [https://jhuwit.github.io/wearabler/](https://jhuwit.github.io/wearabler/)
...
- Shown as strongest predictor of mortality [@tabacu2020quantifying; @leroux2024nhanes] 
...
```{r}
#| eval: false
data = acti_read_gt3x(here("data/TAS1H30182791 (2026-04-29).gt3x"))
...
::: {.column width="50%"}
![](../assets/ac_with_counts.png){width="70%"}
:::
...
This work is based off the [`activerse`](https://github.com/jhuwit/activerse), which is maintained by Johns Hopkins Wearable and Implantable Technology (WIT) group, with code at [https://github.com/jhuwit](https://github.com/jhuwit).
